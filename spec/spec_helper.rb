...
Spork.prefork do
  ...
  # Checks for pending migrateions before tests are run.
  # If you are not using ActiveRecoed, you can remove this line
  ActiveRecord::Migration.check_pending! if defined?(ActionRecord::Migration)
